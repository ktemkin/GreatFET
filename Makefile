...
prepare_release: firmware RELEASENOTES
	...
	@echo "    pushd host; python2 setup.py register; python3 setup.py register; popd"
	@echo "    pushd libgreat/host; python2 setup.py register; python3 setup.py register; popd"
